...
execute as @a[tag=join_reflexes_00_128] at @s unless data entity @s {SelectedItem:{id:"minecraft:lapis_lazuli",tag:{item_128:"diamond_128_:15_items_reflexes_00_00"}}} run function reflexes_00_128:system/reflex/task/failed
execute as @a[tag=join_reflexes_00_128] at @s if data entity @s {SelectedItem:{id:"minecraft:lapis_lazuli",tag:{item_128:"diamond_128_:15_items_reflexes_00_00"}}} run function reflexes_00_128:system/reflex/task/successful
