...
execute as @a[tag=join_reflexes_00_128] at @s if score @s ender_pearl_reflexes_00_128 matches 1.. run function reflexes_00_128:system/reflex/task/successful
execute as @a[tag=join_reflexes_00_128] at @s unless score @s ender_pearl_reflexes_00_128 matches 1.. run function reflexes_00_128:system/reflex/task/failed
