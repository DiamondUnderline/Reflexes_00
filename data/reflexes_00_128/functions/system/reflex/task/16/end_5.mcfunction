...
execute as @a[tag=join_reflexes_00_128] at @s if data entity @s {SelectedItemSlot:5} run function reflexes_00_128:system/reflex/task/successful
execute as @a[tag=join_reflexes_00_128] at @s unless data entity @s {SelectedItemSlot:5} run function reflexes_00_128:system/reflex/task/failed
