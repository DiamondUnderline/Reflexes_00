...
execute as @a[tag=join_reflexes_00_128] at @s if score @s golden_hoe_reflexes_00_128 matches 1.. run function reflexes_00_128:system/reflex/task/successful
execute as @a[tag=join_reflexes_00_128] at @s unless score @s golden_hoe_reflexes_00_128 matches 1.. run function reflexes_00_128:system/reflex/task/failed
...
fill ~ ~ ~ ~ ~ ~ minecraft:air[] replace minecraft:oak_leaves[]
scoreboard players set @s golden_apple_reflexes_00_128 0
scoreboard players reset @s golden_apple_reflexes_00_128
