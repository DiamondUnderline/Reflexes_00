...
execute as @a[tag=join_reflexes_00_128] at @s if score @s sneak_reflexes_00_128 matches 1.. run function reflexes_00_128:system/reflex/task/successful
execute as @a[tag=join_reflexes_00_128] at @s unless score @s sneak_reflexes_00_128 matches 1.. run function reflexes_00_128:system/reflex/task/failed
...
scoreboard players set @a sneak_reflexes_00_128 0
scoreboard players reset @a sneak_reflexes_00_128
