...
execute as @a[tag=join_reflexes_00_128] at @s if block ~ ~-1 ~ minecraft:emerald_block run function reflexes_00_128:system/reflex/task/successful
execute as @a[tag=join_reflexes_00_128] at @s unless block ~ ~-1 ~ minecraft:emerald_block run function reflexes_00_128:system/reflex/task/failed
