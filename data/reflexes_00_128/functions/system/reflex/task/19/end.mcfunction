...
execute as @a[tag=join_reflexes_00_128] at @s if entity @s[x_rotation=-90.0..-72.0] run function reflexes_00_128:system/reflex/task/successful
execute as @a[tag=join_reflexes_00_128] at @s unless entity @s[x_rotation=-90.0..-72.0] run function reflexes_00_128:system/reflex/task/failed
