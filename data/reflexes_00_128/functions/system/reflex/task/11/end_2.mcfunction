...
execute as @a[tag=join_reflexes_00_128] at @s unless data entity @s {Inventory:[{Slot:103b,id:"minecraft:chainmail_helmet"}]} run function reflexes_00_128:system/reflex/task/failed
execute as @a[tag=join_reflexes_00_128] at @s if data entity @s {Inventory:[{Slot:103b,id:"minecraft:chainmail_helmet"}]} run function reflexes_00_128:system/reflex/task/successful
